...
class ListView extends React.Component {
  ...
  render() {
    ...
    const rows = parseInt(this.state.height / rowHeight, 10);
    const totalHeight = rows * this.state.height;
    ...
    return (
      <div ref={this.listRef} style={{ height: '100vh', overflowY: 'scroll' }}>
